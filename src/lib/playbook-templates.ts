  ...
  squads: [
    {
      ...
      squad_order: 0,
      roles: [
        { role_name: 'Squad Leader', role_order: 0, role_tasks: [] },
        { role_name: 'Automatic Rifleman', role_order: 1, role_tasks: [] },
        { role_name: 'Medic', role_order: 2, role_tasks: [] },
        { role_name: 'Engineer', role_order: 3, role_tasks: [] },
        { role_name: 'Anti-Tank', role_order: 4, role_tasks: [] },
        { role_name: 'Rifleman', role_order: 5, role_tasks: [] },
      ],
      tasks: [
    ...
    },
    {
      ...
      roles: [
        ...
        { role_name: 'Automatic Rifleman', role_order: 1, role_tasks: [] },
        { role_name: 'Medic', role_order: 2, role_tasks: [] },
        { role_name: 'Support', role_order: 3, role_tasks: [] },
        { role_name: 'Assault', role_order: 4, role_tasks: [] },
        { role_name: 'Rifleman', role_order: 5, role_tasks: [] },
      ],
      tasks: [
    ...
    },
    {
      ...
      roles: [
        { role_name: 'Squad Leader', role_order: 0, role_tasks: [] },
        { role_name: 'Machine Gunner', role_order: 1, role_tasks: [] },
        { role_name: 'Medic', role_order: 2, role_tasks: [] },
        { role_name: 'Support', role_order: 3, role_tasks: [] },
        { role_name: 'Assault', role_order: 4, role_tasks: [] },
        { role_name: 'Rifleman', role_order: 5, role_tasks: [] },
